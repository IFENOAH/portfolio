  ...
  return (
    <div className={styles.stack_container}>
      ...
      <span className={styles.text}>
        {" "}
        I make use of technologies and languages such as:{" "}
      </span>

      <div className={styles.stack_holder}>
        <span className={styles.tool}>
          {" "}
          <img src={image2} alt="dot" className={styles.img}></img> HTML{" "}
        </span>
        <span className={styles.tool}>
          {" "}
          <img src={image3} alt="dot" className={styles.img}></img>CSS
        </span>
        <span className={styles.tool}>
          {" "}
          <img src={image4} alt="dot" className={styles.img}></img>SCSS
        </span>
        <span className={styles.tool}>
          {" "}
          <img src={image5} alt="dot" className={styles.img2}></img>TAILWIND CSS
        </span>
        <span className={styles.tool}>
          {" "}
          <img src={image6} alt="dot" className={styles.img2}></img>JAVASCRIPT
        </span>
        <span className={styles.tool}>
          {" "}
        ...
        <span className={styles.tool}>
          {" "}
          <img src={image7} alt="dot" className={styles.img3}></img>REACT
        </span>
        <span className={styles.tool}>
          {" "}
          <img src={image8} alt="dot" className={styles.img3}></img>REDUX
        </span>
        <span className={styles.tool}>
          {" "}
          <img src={image9} alt="dot" className={styles.img3}></img>NEXT.JS
        </span>
        <span className={styles.tool}>
          {" "}
          <img src={image10} alt="dot" className={styles.img}></img>GIT
        </span>
        <span className={styles.tool}>
          {" "}
